...
describe("request_patterns", () => {
    ...
    it("Respects Backpressure Requester", done => {
        let counter = 0;
        const requester = new BehaviorSubject(1);
    ...
    it("Handles Request Response / dataOnly", done => {
        socket.addRequestResponseHandler('/basic/request-response', input => input + '-hello');
    ...
    it("Handles Request Response / decodedPayload", done => {
        ...
        socket.addRequestResponseHandler('/basic/request-response', input => ({ data: input + '-hello' }), { payloadType: 'decodedPayload' });
        socket.simpleRequestResponse('/basic/request-reverse-response', {
            topic: '/basic/request-response',
            data: "world"
        }).subscribe(ans => {
    ...
    it("Handles Empty Request Response", done => {
        socket.addRequestResponseHandler('/basic/empty-request-response', data => {
    ...
    it("Handles Request Stream", done => {
        socket.addRequestStreamHandler('/basic/request-response', data => range(0, Number(data)));
    ...
    it("Authenticates using simple authentication on request-response", done => {
        socket.simpleRequestResponse('/secure/request-response', 'DoSthUnallowed', {
            type: 'simple',
            username: 'user',
            password: 'pass'
        }).subscribe(ans => {
    ...
    it("Authenticates using simple authentication on request-stream", done => {
        socket.simpleRequestStream('/secure/request-stream', 'DoSthUnallowed', undefined, {
            type: 'simple',
            username: 'user',
            password: 'pass'
        }).subscribe(ans => {
    ...
    it("Fails  unauthenticated", done => {
        socket.simpleRequestResponse('/secure/request-response', 'DoSthUnallowed').subscribe(ans => {
    ...
    it("Send fragments", done => {
        ...
        socket.simpleRequestResponse('/basic/request-response/byte', databuffer).subscribe(ans => {
            for (let i = 0; i < databuffer.length; i++) {
